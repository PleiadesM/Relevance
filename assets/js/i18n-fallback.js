...
export const FALLBACK_EN = {
  ...
  "onboarding": {
    ...
    "step4": "Add any API keys you want under Settings → Secrets and variables → Actions (a passphrase for private mode, optional keys for AI summaries).",
    "step5": "Open the “Set up my Relevance” issue in your repository to choose sources, theme, language, and privacy.",
    "refresh": "Refresh"
  },
  "tutorial": {
    ...
    "s2Title": "① Add your keys",
    "s2Body": "Some features need secrets: a passphrase (NEWSDASH_PASSPHRASE) to unlock private mode, and optional API keys for AI summaries. Add them under Settings → Secrets and variables → Actions.",
    "s2Action": "Open repository secrets →",
    "s2Note": "Never paste a secret or a private feed URL into an issue — issues are public. A secret's value belongs only in Settings.",
    "s3Title": "② Set up your site",
    "s3Body": "Open a “Set up my Relevance” issue in your repository to choose your language, theme, starter sources, and whether the site is public or private. A bot applies your choices and rebuilds.",
    "s3Action": "Open the setup issue →",
